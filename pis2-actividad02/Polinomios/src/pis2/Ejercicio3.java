...
public class Ejercicio3 {
	...
	public boolean evaluaciones(double fxizq, double fxr) {
		/**
		 * EVALUACIONES Si f(xizq)*f(xr)<0 : redefinir límite derecho del
		 * intervalo: xder - xr Si f(xizq)*f(xr)>0 : redefinir límite izquierdo
		 * del intervalo: xizq - xr Si f(xizq)*f(xr)=0 : hay una raíz en xr
		 */
